...
type Querier interface {
	...
	DeleteExerciseItemById(ctx context.Context, arg DeleteExerciseItemByIdParams) (int64, error)
	...
	UpdateExerciseItemType(ctx context.Context, arg UpdateExerciseItemTypeParams) (int64, error)
